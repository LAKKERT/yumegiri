...
export function Header() {
    ...
    return (
        <div className={`flex items-center fixed top-0 w-full h-25 bg-[#FFA685] text-nowrap font-(family-name:--font-pacifico) z-50`}>
            <div className="mx-auto flex justify-center items-center flex-row gap-5 tracking-wide text-md 2xl:text-lg">
                ...
                <Link href="/" className="text-3xl font-(family-name:--font-kiwimaru)">
                    ユ メギリ
                </Link>
