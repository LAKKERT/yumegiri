...
export function InrtoductionPart() {
    ...
    return (
        <div className="relative h-screen">
            <h1 className="absolute text-3xl lg:text-6xl font-[family-name:var(--font-kiwimaru)] top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10">こんにちは</h1>
